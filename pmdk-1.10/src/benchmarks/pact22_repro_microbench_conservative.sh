...
dir_name="pact22_artifact_eval_conservative"
csv_name="pavise_conservative_microbench"
iters=1
...
cp ${dir_name}/${csv_name}.csv $PAVISE_ROOT/results/microbench_conservative.csv
